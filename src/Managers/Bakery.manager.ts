...
export class BakeryManager implements IBakeryManager {
    getMinimunPackges(bakeryItems: BakeryItemModel[]): BakeryResultModel[] {
        const result: BakeryResultModel[] = [];

        bakeryItems.forEach(bakeryItem => {
            const typePackages = this.getMinimumPackagesForItem(bakeryItem);
    ...
    getMinimumPackagesForItem(bakeryItem: BakeryItemModel): BakeryResultModel {
